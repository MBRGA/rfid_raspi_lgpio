...
constexpr uint8_t MFRC522_firmware_referenceV1_0[] = {
...
public:
	...
	enum PCD_Register : unsigned char {
	...
	enum PCD_Command : unsigned char {
	...
	enum PICC_Command : unsigned char {
	...
	/////////////////////////////////////////////////////////////////////////////////////
	void PCD_Init();
	void PCD_Init(int resetPowerDownPin);
	void PCD_Init(int chipSelectPin, int resetPowerDownPin);
	void PCD_Reset();
	void PCD_AntennaOn();
	void PCD_AntennaOff();
...
protected:
	int _gpioHandle;		// Handle to gpiochip device
	int _spiHandle;			// Handle to SPI device
	int _chipSelectPin;		// Pin connected to MFRC522's SPI slave select input (Pin 24, NSS, active low)
	int _resetPowerDownPin;	// Pin connected to MFRC522's reset and power down input (Pin 6, NRSTPD, active low)
